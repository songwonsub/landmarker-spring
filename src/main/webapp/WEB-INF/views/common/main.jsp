	                ...
	                <div class="col-md-6 animated fadeIn">
	                    <div class="owl-carousel header-carousel">
	                        <div class="owl-carousel-item">
	                            <img class="img-fluid" src="${ pageContext.servletContext.contextPath }/resources/img/carousel-1.jpg" alt="">
	                        </div>
	                        <div class="owl-carousel-item">
	                            <img class="img-fluid" src="${ pageContext.servletContext.contextPath }/resources/img/carousel-2.jpg" alt="">
	                        </div>
	                    </div>
	                </div>
	            </div>
	                        ...
	                        <div class="team-item rounded overflow-hidden">
	                            <div class="position-relative">
	                                ...
	                                <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
	                                    <a class="btn btn-square mx-1" href="${ pageContext.servletContext.contextPath }/resources/"><i class="fab fa-facebook-f"></i></a>
	                                    <a class="btn btn-square mx-1" href="${ pageContext.servletContext.contextPath }/resources/"><i class="fab fa-twitter"></i></a>
	                                    <a class="btn btn-square mx-1" href="${ pageContext.servletContext.contextPath }/resources/"><i class="fab fa-instagram"></i></a>
	                                </div>
	                            </div>
